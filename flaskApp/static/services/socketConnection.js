angular.module('dcs.services').service('socketConnection', 
	function()
	{
		...
		this.setupEvents = 
			function()
			{
				var messages = ['metadata', 'data', 'renameColumn', 'deleteRows', 'changeColumnDataType', 'fillDown', 'interpolate', 'fillWithCustomValue', 'fillWithAverage', 'normalize', 'standardize', 'deleteRowsWithNA', 'findReplace', 'analyze', 'dataChanged'];
				messages.forEach(
					function(message)
					{
